  ...
  return (
    <body>
      ...
      <main>
        ...
        <p>
          Here at PetGrab we feel that a true pet parent should be less concerned with the breed of your bed than the experiences that pet gives you. Each one of our pets are hand-picked from local kill-shelters and placed here on our platform. The fast turnaround time allow for less stress on the animals, saves them from unecessary death, and facilitates an efficient way for us to help improve both the lives of these unfortunate animals and you!
        </p>
        <p>
